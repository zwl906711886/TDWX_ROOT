  ...
  <div style=" margin-bottom: 80px">
    <el-card>
      <div style="text-align: center;">
        <h2>{{this.$route.params.questionContent}}</h2>
      </div>
...
export default {
  ...
  methods: {
    loadMessage() {
      // alert(this.$route.params.questionId)
      request.get("/message/foreign/",{
        params: {
    ...
    save() {
      ...
      request.post("/message", this.entity,{
        params: {
          foreignId:this.$route.params.questionId
        }
      }).then(res => {
